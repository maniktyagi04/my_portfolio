      ...
      <div className="flex flex-col lg:flex-row-reverse items-center lg:items-start gap-12">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 mb-8">
            I am a first-year B.Tech student at Newton School of Technology with a strong foundation in Python, HTML, CSS, JavaScript, and React. I was always passionate about full-stack development and have hands-on experience in UI/UX design, creating user-friendly and responsive interfaces. With a strong drive for continuous learning and innovation, I aim to build impactful tech solutions while constantly improving my software development and product design expertise.
          </p>
